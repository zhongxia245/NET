...
namespace CollectApp.common
{
    public class ExcelHelper
    {
        ...
        public string DataSetToExcel(DataSet ds, Hashtable ht = null)
        {
            try
            {
        ...
        public string DatatableToExcel(DataTable dt,Hashtable ht = null, String name = "sheet1")
        {
            try
            {
                sheet.Name = name;
                AddHeader(dt, null, ht);
                AddBody(dt);
                sheet.AutoFitColumns();
                sheet.AutoFitRows();
                book.Save(outFileName);
